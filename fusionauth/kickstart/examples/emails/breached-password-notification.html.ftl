...
<a href="https://auth.dev.test/password/forgot?email=${user.email}&tenantId=${user.tenantId}">
  https://auth.dev.test/password/forgot?email=${user.email}&tenantId=${user.tenantId}
</a>
